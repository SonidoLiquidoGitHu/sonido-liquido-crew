...
export const backgroundStyles = [
  {
    value: "gradient-dark",
    label: "Gradiente Oscuro",
    className: "bg-gradient-to-br from-slc-black via-slc-dark to-slc-black",
    mode: "dark",
  },
  {
  ...
  },
  {
    value: "solid-black",
    label: "Negro Sólido",
    className: "bg-slc-black",
    mode: "dark",
  },
  {
    value: "solid-dark",
    label: "Gris Oscuro",
    className: "bg-slc-dark",
    mode: "dark",
  },
  {
    value: "noise",
...
export const titleStyles = [
  ...
  {
    value: "gradient",
    label: "Gradiente de Texto",
    className: "bg-gradient-to-r bg-clip-text text-transparent",
  },
  {
    value: "outlined",
    label: "Contorno",
    className: "text-transparent [-webkit-text-stroke:2px_currentColor]",
  },
  {
    value: "shadow",
    label: "Con Sombra",
    className: "drop-shadow-[0_0_25px_currentColor]",
  },
] as const;
...
export function getStyleVariables(
  ...
  const primary =
    merged.primaryColor || preset?.primary || defaultStyleSettings.primaryColor;
  const secondary =
    merged.secondaryColor ||
    preset?.secondary ||
    defaultStyleSettings.secondaryColor;
  const accent =
    merged.accentColor || preset?.accent || defaultStyleSettings.accentColor;
...
export function getButtonClasses(settings: Partial<StyleSettings>): string {
  ...
  const styleMap = {
    ...
    gradient:
      "bg-gradient-to-r from-[var(--style-primary)] to-[var(--style-secondary)] hover:opacity-90",
    outline:
      "border-2 border-[var(--style-primary)] hover:bg-[var(--style-primary)]/10",
    glass:
