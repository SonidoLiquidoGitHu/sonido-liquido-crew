...
export const videoAnalyticsAggregates = sqliteTable(
  "video_analytics_aggregates",
  {
    id: text("id").primaryKey(),
...
export type VideoAnalyticsAggregate =
  typeof videoAnalyticsAggregates.$inferSelect;
export type NewVideoAnalyticsAggregate =
  typeof videoAnalyticsAggregates.$inferInsert;
