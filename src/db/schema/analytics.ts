...
export const videoAnalyticsAggregates = sqliteTable("video_analytics_aggregates", {
  ...
  dropped25: integer("dropped_25").notNull().default(0),
  dropped50: integer("dropped_50").notNull().default(0),
  dropped75: integer("dropped_75").notNull().default(0),
  dropped100: integer("dropped_100").notNull().default(0),
