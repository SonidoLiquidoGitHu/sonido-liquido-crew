...
export const metadata = {
  ...
  description:
    "Próximos conciertos, fiestas y presentaciones en vivo de Sonido Líquido Crew.",
};
    ...
    return (
      <div className="text-center py-16">
        ...
        <p className="text-slc-muted max-w-md mx-auto">
          No hay eventos programados en este momento. Síguenos en redes sociales
  ...
  return (
    <div className="space-y-4">
      {Array.from({ length: 5 }).map((_, i) => (
        <Skeleton key={`event-skeleton-${i}`} className="h-24 rounded-lg" />
      ))}
    </div>
  );
}
