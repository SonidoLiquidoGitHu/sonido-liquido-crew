                ...
                <div className="flex gap-1.5 text-center">
                  {timeRemaining.days > 0 && (
                    <div className="bg-black/60 backdrop-blur-sm rounded px-2 py-1">
                      <div className="font-oswald text-lg text-white leading-none">
                        {timeRemaining.days}
                      </div>
                      <div className="text-[8px] text-white/60 uppercase">
                        días
                      </div>
                    </div>
                  )}
                  ...
                  <div className="bg-black/60 backdrop-blur-sm rounded px-2 py-1">
                    <div className="font-oswald text-lg text-primary leading-none">
              ...
              <div className="flex gap-2 mt-1">
                ...
                {release.distrokidHyperfollowUrl && (
                  <Link
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-8 h-8 rounded-full bg-orange-500/20 hover:bg-orange-500/40 flex items-center justify-center transition-colors"
                    onClick={() => trackPresaveClick("hyperfollow")}
                  >
                    <svg
        ...
        <div className="p-3">
          ...
          <p className="text-xs text-slc-muted mb-2 line-clamp-1">
            ...
            {release.featuredArtists && (
              <span className="text-slc-muted/70">
                {" "}
      ...
      <div className="flex flex-col md:flex-row items-center gap-6">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="text-sm text-slc-muted mb-4">
            Activa las notificaciones y te avisaremos cuando se acerque la fecha
            de lanzamiento
          </p>
        ...
        <div className="section-container relative z-10">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <h1 className="font-oswald text-4xl md:text-5xl uppercase mb-4">
              Próximos <span className="text-primary">Lanzamientos</span>
            </h1>
