...
function ReleaseCard({ release }: { release: UpcomingRelease }) {
  ...
  const hasPresave = Boolean(release.rpmPresaveUrl || release.spotifyPresaveUrl || release.appleMusicPresaveUrl || (release as any).distrokidHyperfollowUrl);
          ...
          <div className={cn(
            ...
            {hasPresave && (
              <div className="flex gap-2 mt-1">
                ...
                {(release as any).distrokidHyperfollowUrl && (
                  <Link
                    href={(release as any).distrokidHyperfollowUrl}
                    target="_blank"
                    rel="noopener noreferrer"
