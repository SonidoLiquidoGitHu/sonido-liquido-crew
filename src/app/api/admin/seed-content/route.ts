...
const sampleBeats = [
  {
    ...
    duration: 180,
    previewAudioUrl:
      "https://cdn.pixabay.com/audio/2024/11/14/audio_8ce7e32988.mp3",
    coverImageUrl:
  ...
  },
  {
    ...
    duration: 240,
    previewAudioUrl:
      "https://cdn.pixabay.com/audio/2024/09/03/audio_6e5d7c6bcc.mp3",
    coverImageUrl:
  ...
  },
  {
    ...
    duration: 195,
    previewAudioUrl:
      "https://cdn.pixabay.com/audio/2024/08/27/audio_79e0c50d86.mp3",
    coverImageUrl:
  ...
  },
  {
    ...
    duration: 210,
    previewAudioUrl:
      "https://cdn.pixabay.com/audio/2024/06/27/audio_d2c87b23b4.mp3",
    coverImageUrl:
  ...
  },
  {
    ...
    duration: 225,
    previewAudioUrl:
      "https://cdn.pixabay.com/audio/2024/05/15/audio_e1c8b0d2a1.mp3",
    coverImageUrl:
...
const sampleCampaigns = [
  {
    ...
    description:
      "Pre-guarda el nuevo álbum de Zaque y sé el primero en escucharlo. Incluye 12 tracks inéditos.",
  ...
  },
  {
    ...
    description:
      "Escucha la playlist Gran Reserva de Sonido Líquido en tu plataforma favorita.",
  ...
  },
  {
    ...
    description:
      "Descarga 5 beats exclusivos de Codak y Fancy Freak. Perfecto para freestylers y MCs emergentes.",
  ...
  },
  {
    ...
    description:
      "Participa en el concurso de remixes. El ganador será incluido en el próximo EP oficial.",
...
const sampleMediaReleases = [
  {
    ...
    summary:
      "El colectivo más representativo del Hip Hop mexicano celebra un cuarto de siglo con gira nacional y nuevo material.",
...
Además de la gira, se prepara un álbum compilatorio con colaboraciones entre todos los miembros del roster actual y leyendas invitadas.`,
    pullQuote:
      "25 años haciendo historia. Esto es más que música, es un movimiento cultural que trasciende generaciones.",
  ...
  },
  {
    ...
    summary:
      "El fundador de SLC presenta un adelanto de su próximo álbum con producción de Fancy Freak.",
...
- Deezer`,
    pullQuote:
      "No hay límite cuando la pasión te impulsa. Esta canción resume todo lo que hemos construido.",
  ...
  },
  {
    ...
    summary:
      "Dos pilares del crew unen fuerzas para un EP de 6 tracks que explorará nuevos territorios sonoros.",
...
El primer sencillo del EP será revelado en las próximas semanas a través de las redes sociales oficiales.`,
  ...
  },
  {
    ...
    summary:
      "La cantante de SLC fue seleccionada para representar al Hip Hop mexicano en el festival más grande de Latinoamérica.",
...
Latin Geisha se presentará en el escenario principal el sábado 15 de octubre, con un set de 45 minutos que incluirá material de su discografía y adelantos de su próximo álbum.`,
  ...
  },
  {
    ...
    category: "announcement" as const,
    summary:
      "El MC y productor abre las puertas de su nuevo estudio de grabación en la Ciudad de México.",
...
const sampleEvents = [
  {
    ...
    description:
      "Celebramos 25 años de historia con todos los artistas del roster en un show épico. Invitados especiales y sorpresas.",
  ...
  },
  {
    ...
    description:
      "Representando a México en el festival más grande de Hip Hop en Latinoamérica. Latin Geisha y Zaque en el escenario principal.",
  ...
  },
  {
    ...
    description:
      "Sesión de freestyle con DJs en vivo. Entrada libre. Todos los MCs bienvenidos.",
  ...
  },
  {
    ...
    description:
      "Lanzamiento del EP colaborativo 'Dualidad'. Presentación en vivo con invitados especiales.",
    venue: "Foro Alicia",
    city: "Ciudad de México",
    country: "México",
  ...
  },
  {
    ...
    description:
      "Brez representa al crew en el escenario Hip Hop del festival.",
  ...
  },
  {
    ...
    description:
      "Masterclass de producción musical. Aprende técnicas de sampling, mezcla y beatmaking con uno de los productores más reconocidos del crew.",
    venue: "Casa del Lago",
    city: "Ciudad de México",
    country: "México",
  ...
  },
  {
    ...
    description:
      "Una noche dedicada al Hip Hop clásico. Sets de DJs y presentaciones en vivo.",
    venue: "Bajo Circuito",
    city: "Ciudad de México",
    country: "México",
  ...
  },
  {
    ...
    description:
      "Show completo con Zaque, K-Oso, y Simpson Ahuevo. Gira nacional 2026.",
    venue: "Café Iguana",
    city: "Monterrey",
    country: "México",
...
const samplePhotos = [
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1504898770365-14faca6a7320?w=1200",
    thumbnailUrl:
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1561059488-916d69792237?w=1200",
    thumbnailUrl:
