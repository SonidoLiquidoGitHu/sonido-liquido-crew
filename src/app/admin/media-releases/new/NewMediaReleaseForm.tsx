...
export default function NewMediaReleaseForm({
  artists,
}: NewMediaReleaseFormProps) {
  ...
  const handleBulkTracksUpload = (
    tracks: { title: string; url: string; duration: string }[],
  ) => {
            ...
            {activeTab === "audio" && (
              <div className="space-y-6">
                ...
                <div className="bg-slc-dark border border-slc-border rounded-xl p-6">
                  ...
                  <p className="text-sm text-slc-muted mb-4">
                    Sube múltiples audios y gestiona el tracklist del
                    lanzamiento.
                  </p>
                  <BulkAudioUploader
                    ...
                    {formData.audioTracks.length > 0 && (
                      <div className="space-y-4">
                        {formData.audioTracks.map((track, index) => (
                          <div
                            key={index}
                            className="bg-slc-card rounded-lg p-4 flex items-center gap-4"
                          >
                            ...
                            <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-2">
                              ...
                              <DirectDropboxUploader
                                ...
                                folder="/media-releases/tracks"
                                label={
                                  track.url ? "Cambiar audio" : "Subir audio"
                                }
