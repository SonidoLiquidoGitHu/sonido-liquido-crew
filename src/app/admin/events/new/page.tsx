  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        showMessage("error", data.error?.message || "Error al crear evento");
      }
    } catch (error) {
  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="font-oswald text-3xl uppercase">Nuevo Evento</h1>
          <p className="text-slc-muted mt-1">
            Crea un concierto, presentación o evento
          </p>
        </div>
      </div>
