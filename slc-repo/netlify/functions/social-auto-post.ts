...
// Picks the next pending item from social_post_queue and posts to FB + IG + TikTok.
// Only processes ONE item per run (3 items/day × up to 3 platforms = up to 9 posts/day).
